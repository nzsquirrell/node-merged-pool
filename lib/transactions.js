...
var generateOutputTransactions = function(poolRecipient, recipients, rpcData, symbol){
...
exports.CreateGeneration = function(rpcData, publicKey, extraNoncePlaceholder, reward, txMessages, recipients, auxMerkleTree, coinbaseText, symbol){
    ...
    var outputTransactions = generateOutputTransactions(publicKey, recipients, rpcData, symbol);
